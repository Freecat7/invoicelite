...
CREATE TABLE "new_RecurringInvoice" (
    ...
    "servicePeriod" TEXT NOT NULL DEFAULT 'none',
...
INSERT INTO "new_RecurringInvoice" ("clientId", "createdAt", "currency", "discountType", "discountValue", "endDate", "footer", "frequency", "generateAs", "id", "lastRunAt", "nextRunDate", "notes", "paymentTermDays", "remainingCycles", "status", "taxRegime", "terms", "title", "updatedAt") SELECT "clientId", "createdAt", "currency", "discountType", "discountValue", "endDate", "footer", "frequency", "generateAs", "id", "lastRunAt", "nextRunDate", "notes", "paymentTermDays", "remainingCycles", "status", "taxRegime", "terms", "title", "updatedAt" FROM "RecurringInvoice";
